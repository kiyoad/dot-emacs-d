...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (flycheck-popup-tip undo-tree eldoc-overlay expand-region trr typit symbol-overlay ace-window origami mwim multiple-cursors goto-chg ggtags linum-relative ibuffer-projectile helm-projectile projectile jaword ido-skk focus company-jedi company elscreen helm-elscreen markdown-toc yasnippet-snippets js2-mode web-mode visual-regexp flatui-theme adoc-mode ansible avy ddskk scratch-pop japanese-holidays bm helm smart-cursor-color prompt-text ietf-docs hiwin go-errcheck go-direx direx go-eldoc helm-go-package mo-git-blame bbyac helm-c-yasnippet ace-isearch auto-complete browse-kill-ring color-moccur dockerfile-mode fill-column-indicator fold-dwim go-mode google-translate helm-ag helm-google helm-swoop ido-vertical-mode json-mode lispxmp magit markdown-mode migemo pangu-spacing popwin recentf-ext shell-pop smart-newline smart-tab smartparens smex which-key yaml-mode zop-to-char yasnippet shrink-whitespace persp-mode isearch-dabbrev init-loader helm-bm exec-path-from-shell easy-kill bind-key auto-async-byte-compile))))
(custom-set-faces
